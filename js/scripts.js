...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Backend Stack.","Frontend Stack.", "Data Science.", "Full Stack Developer.", ],    /* You can change the home section typing text from
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "220 John St, Apt 10103, Rochester, NY -14623",  /* You can change your address from here */
            html: "<b>Address</b>: <br> 220 John St, Apt 10103, Rochester, NY -14623",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
